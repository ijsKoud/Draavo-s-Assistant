...
let {body} = await superagent
    .get(others.birdFactRandomURL)

    if (!{body}) return message.channel.send("Oops, It looks like I broke myself! Please try again later.");

    var birdFactEmbed = new discord.MessageEmbed()
        .setAuthor(`${serverName} Bird Fact Service`, serverIcon)
    ...
    msg.edit("Generated!");
    message.channel.send(birdFactEmbed);
